...
public class ServiceDBImpl<T> implements ServiceDB<T> {
    private static Logger logger = LoggerFactory.getLogger(ServiceDBImpl.class);
    ...
    public ServiceDBImpl(DataSource dataSource, Class<? extends T> clazz) {
        this.dataSource = dataSource;
        this.mapper = new JdbcMapper<>(clazz);
        this.cache = new MyCache<>(5);
    }
