...
import ru.otus.jdbc.dao.IDBExecutor;
...
public class JdbcTemplate<T> implements IJdbcTemplate<T> {
    ...
    private IDBExecutor<T> executer;
    private JdbcMapper<T> mapper;

    public JdbcTemplate(DataSource dataSource, Class<? extends T> clazz) {
    ...
    public void createTable() throws SQLException {
        ...
        try(Connection connection = dataSource.getConnection()){
            executer = new DBExecutor<>(connection);
