...
import ru.otus.jdbc.templates.IJdbcTemplate;
...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        IJdbcTemplate<User> userJdbc = new JdbcTemplate<>(dataSource, User.class);
        ...
        IJdbcTemplate<Account> accountJdbc = new JdbcTemplate<>(dataSource, Account.class);
