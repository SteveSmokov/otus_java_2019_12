...
class AdminUserServiceTest {
    ...
    private final HibernateUtils hibernateUtils = new HibernateUtils("ru.otus.entities");
    private final SessionManager sessionManager = new SessionManagerHibernate(hibernateUtils.buildSessionFactory());
    private final AdminUserDao userDao = new AdminUserDaoImpl(sessionManager);
    private final HwCache<Long, User> userHwCache = new MyCache<>(10);
    private final AdminUserService userService = new AdminUserServiceImp(new AdminUserDaoImpl(sessionManager), userHwCache);
    private User user1;
    private User user2;
